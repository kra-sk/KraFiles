...
import sk.kra.files.file.asExternalStorageUri
import sk.kra.files.provider.document.resolver.ExternalStorageProviderHacks
...
class AddStorageDialogFragment : AppCompatDialogFragment() {
    ...
    companion object {
        private val STORAGE_TYPES = listOfNotNull(
            ...
            R.string.storage_add_storage_kra_server to
                EditKraServerActivity::class.createIntent().putArgs(EditKraServerFragment.Args(null)),
        )
    }
}
