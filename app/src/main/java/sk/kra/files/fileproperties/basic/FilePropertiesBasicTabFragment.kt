...
package sk.kra.files.fileproperties.basic
...
import sk.kra.files.filelist.getMimeTypeName
import sk.kra.files.filelist.name
import sk.kra.files.filelist.toUserFriendlyString
import sk.kra.files.fileproperties.FilePropertiesFileViewModel
import sk.kra.files.fileproperties.FilePropertiesTabFragment
import sk.kra.files.provider.archive.ArchiveFileAttributes
