...
import sk.kra.files.provider.webdav.client.isDirectory
import sk.kra.files.provider.webdav.client.isSymbolicLink
import sk.kra.files.provider.webdav.client.lastModifiedTime
import sk.kra.files.provider.webdav.client.size
