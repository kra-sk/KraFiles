...
import sk.kra.files.provider.common.AbstractFileByteChannel
import sk.kra.files.provider.common.EMPTY
import sk.kra.files.provider.common.asFuture
import sk.kra.files.provider.common.map
import sk.kra.files.util.closeSafe
import sk.kra.files.util.findCauseByClass
