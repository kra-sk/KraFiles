...
package sk.kra.files.viewer.image
...
import sk.kra.files.databinding.ImageViewerFragmentBinding
import sk.kra.files.file.fileProviderUri
import sk.kra.files.provider.common.delete
import sk.kra.files.ui.DepthPageTransformer
import sk.kra.files.util.ParcelableArgs
import sk.kra.files.util.ParcelableListParceler
import sk.kra.files.util.ParcelableState
import sk.kra.files.util.args
import sk.kra.files.util.createSendImageIntent
...
import sk.kra.files.util.mediumAnimTime
