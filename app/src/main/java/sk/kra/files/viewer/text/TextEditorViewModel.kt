...
package sk.kra.files.viewer.text
...
import sk.kra.files.provider.common.readAllBytes
import sk.kra.files.provider.common.size
import sk.kra.files.util.ActionState
import sk.kra.files.util.DataState
import sk.kra.files.util.isFinished
import sk.kra.files.util.isReady
import sk.kra.files.util.toError
import sk.kra.files.util.toLoading
