...
import sk.kra.files.file.asMimeType
import sk.kra.files.file.isApk
import sk.kra.files.file.isImage
import sk.kra.files.file.isMedia
import sk.kra.files.file.isPdf
import sk.kra.files.file.isVideo
import sk.kra.files.file.lastModifiedInstant
import sk.kra.files.filelist.isRemotePath
...
import sk.kra.files.util.setDataSource as appSetDataSource
