...
import sk.kra.files.compat.requireViewByIdCompat
import sk.kra.files.databinding.FileJobConflictDialogViewBinding
...
import sk.kra.files.file.lastModifiedInstant
import sk.kra.files.filelist.appDirectoryPackageName
import sk.kra.files.filelist.supportsThumbnail
import sk.kra.files.provider.common.isEncrypted
import sk.kra.files.util.ParcelableArgs
import sk.kra.files.util.ParcelableState
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see sk.kra.files.filelist.FileListAdapter.onBindViewHolder */
